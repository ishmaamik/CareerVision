...
import InterviewCollabEditor from "./InterviewCollabEditor";
...
const InterviewRoomForm = () => {
  ...
  // If room is already joined, render the Collab Editor
  if (roomInfo) {
    return (
      <InterviewCollabEditor 
        ...
        <div className="px-8 pt-6 pb-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-yellow-300">
              Create or join an interview preparation room
            </p>
          </div>
