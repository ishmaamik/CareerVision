...
const Roadmap = () => {
  ...
  const careerTitle = encodedCareerTitle ? decodeURIComponent(encodedCareerTitle) : "";
  ...
  const careerData = useMemo(() => ({
    ...
    detailedDescription: "Software engineering is the systematic application of engineering approaches to the development of software.",
    recommendedSubjects: ["Mathematics", "Computer Science", "Physics", "Statistics", "Logic"]
  }), [careerTitle]);
  ...
  useEffect(() => {
    const savedProgress = localStorage.getItem(`roadmap_progress_${careerData.careerTitle}`);
    if (savedProgress) {
  ...
  const refreshRoadmap = async () => {
    ...
    const cacheKey = `roadmap_${careerData.careerTitle.toLowerCase().replace(/\s+/g, '_')}`;
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="animate-pulse space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className={`h-96 ${themeClasses.bg.accent} rounded-2xl lg:col-span-2`}></div>
              <div className={`h-96 ${themeClasses.bg.accent} rounded-2xl`}></div>
            </div>
          </div>
        </div>
      </div>
    ...
    return (
      <div className={`min-h-screen ${themeClasses.bg.primary}`}>
        <div className="container mx-auto px-6 py-16 text-center">
          <AlertCircle className={`w-16 h-16 mx-auto mb-4 ${themeClasses.text.muted}`} />
      ...
      <div className={`min-h-screen ${themeClasses.bg.primary}`}>
        <div className="container mx-auto px-6 py-16">
          ...
          <div className="text-center max-w-2xl mx-auto">
            <div className={`w-24 h-24 mx-auto mb-6 bg-gradient-to-r ${themeClasses.brand.gradient} rounded-full flex items-center justify-center`}>
              <Target className="w-12 h-12 text-white" />
            </div>
            
            <h1 className={`text-3xl lg:text-4xl font-bold ${themeClasses.text.primary} mb-4`}>
              {careerData.careerTitle} Learning Roadmap
            </h1>
            
            <p className={`text-lg ${themeClasses.text.secondary} mb-8`}>
              Generate a comprehensive, AI-powered learning roadmap tailored specifically for your {careerData.careerTitle} career journey. 
              This roadmap will guide you from beginner to advanced levels with structured phases, practical projects, and industry insights.
            </p>
            ...
            <div className={`${componentStyles.card} p-8 mb-8`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                <div className="flex items-center space-x-3">
                  <BookOpen className={`w-5 h-5 ${themeClasses.brand.primary}`} />
                  <span className={themeClasses.text.secondary}>Structured learning phases</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Target className={`w-5 h-5 ${themeClasses.brand.primary}`} />
                  <span className={themeClasses.text.secondary}>Clear milestones & goals</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Briefcase className={`w-5 h-5 ${themeClasses.brand.primary}`} />
                  <span className={themeClasses.text.secondary}>Hands-on projects</span>
                </div>
                <div className="flex items-center space-x-3">
                  <TrendingUp className={`w-5 h-5 ${themeClasses.brand.primary}`} />
                  <span className={themeClasses.text.secondary}>Career progression paths</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Globe className={`w-5 h-5 ${themeClasses.brand.primary}`} />
                  <span className={themeClasses.text.secondary}>Industry insights & trends</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Lightbulb className={`w-5 h-5 ${themeClasses.brand.primary}`} />
                  <span className={themeClasses.text.secondary}>Learning resources</span>
                </div>
              </div>
            </div>
            ...
            <p className={`text-sm ${themeClasses.text.muted} mt-4`}>
              This process may take a few moments while our AI creates your personalized roadmap.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg.primary}`}>
      {/* Header */}
      <div className={`${themeClasses.bg.surface} ${themeClasses.border.primary} border-b`}>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                ...
                <div className={`flex items-center ${themeClasses.text.muted}`}>
                  ...
                  <span>{roadmapData?.phases?.length || 0} Learning Phases</span>
                </div>
                <div className={`flex items-center ${themeClasses.text.muted}`}>
            ...
            <div className={componentStyles.card}>
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  >
                    {showProgress ? <ChevronDown className="w-4 h-4" /> : <ChevronRight className="w-4 h-4" />}
                  </button>
                </div>
                  ...
                  <>
                    <div className="mb-4">
                      <div className="flex justify-between text-sm mb-2">
                        <span className={themeClasses.text.secondary}>Overall Progress</span>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className={themeClasses.text.secondary}>Completed Items</span>
                        <span className={themeClasses.text.primary}>
                          {Object.values(completedItems).filter(Boolean).length}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className={themeClasses.text.secondary}>Current Phase</span>
                        <span className={themeClasses.text.primary}>
          ...
          <div className="xl:col-span-3">
            {roadmapData?.phases?.map((phase, phaseIndex) => (
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-4 bg-gradient-to-r ${themeClasses.brand.gradient} text-white font-bold`}>
                        {phaseIndex + 1}
                      </div>
                      <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <div className={`text-sm px-3 py-1 rounded-full ${isDarkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-700'}`}>
                ...
                {/* Phase Content */}
                {expandedPhases[phase.id] && (
                  <div className={`px-6 pb-6 border-t ${themeClasses.border.primary}`}>
                    {/* Subjects */}
                          ...
                          {phase.subjects.map((subject, index) => (
                            ...
                            >
                              <div className="flex items-start justify-between mb-3">
                                <div className="flex-1">
                                  <div className="flex items-center mb-2">
                                    <button
                                      onClick={() => toggleCompletion(phase.id, 'subject', index)}
                                      className="mr-3"
                                    >
                                      {completedItems[`${phase.id}_subject_${index}`] ? (
                                        <CheckCircle className="w-5 h-5 text-green-500" />
                                      ) : (
                                        <Circle className={`w-5 h-5 ${themeClasses.text.muted}`} />
                                      )}
                                    </button>
                                  ...
                                  <p className={`text-sm ${themeClasses.text.secondary} mb-2 ml-8`}>
                                    {subject.description}
                                  </p>
                                </div>
                                <div className="flex flex-col items-end">
                                  ...
                                  <span className={`text-xs ${themeClasses.text.muted} mt-1`}>
                                    {subject.duration}
                                  </span>
                                </div>
                              </div>
                              ...
                              {subject.skills && subject.skills.length > 0 && (
                                <div className="ml-8">
                                  <p className={`text-xs ${themeClasses.text.muted} mb-2`}>Skills you'll gain:</p>
                        ...
                        <div className="space-y-2">
                          {phase.milestones.map((milestone, index) => (
                            <div key={index} className="flex items-center">
                              <button
                                onClick={() => toggleCompletion(phase.id, 'milestone', index)}
                                className="mr-3"
                              >
                                {completedItems[`${phase.id}_milestone_${index}`] ? (
                                  <CheckCircle className="w-5 h-5 text-green-500" />
                                ) : (
                                  <Circle className={`w-5 h-5 ${themeClasses.text.muted}`} />
                                )}
                              ...
                              <span className={`${themeClasses.text.primary} ${
                                completedItems[`${phase.id}_milestone_${index}`] ? 'line-through opacity-75' : ''
                              }`}>
                                {milestone}
                              </span>
                            </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {phase.projects.map((project, index) => (
                            <div key={index} className="flex items-center">
                              <button
                                onClick={() => toggleCompletion(phase.id, 'project', index)}
                                className="mr-3"
                              >
                              ...
                              <span className={`${themeClasses.text.primary} ${
                                completedItems[`${phase.id}_project_${index}`] ? 'line-through opacity-75' : ''
                              }`}>
                                {project}
                              </span>
                            </div>
              ...
              <div className={componentStyles.card}>
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    {Object.entries(roadmapData.careerOutcomes).map(([level, data]) => (
                      <div key={level} className={`p-4 border rounded-lg ${themeClasses.border.primary} ${themeClasses.bg.accent}`}>
                        <h4 className={`font-semibold ${themeClasses.text.primary} mb-2 capitalize`}>
                          {level.replace(/([A-Z])/g, ' $1').trim()}
                        </h4>
                        <div className="space-y-2 text-sm">
                          <div>
                            <span className={`${themeClasses.text.muted}`}>Positions: </span>
                            <span className={themeClasses.text.secondary}>
                              {data.positions?.join(', ')}
                            </span>
                          </div>
                          <div>
                            <span className={`${themeClasses.text.muted}`}>Salary: </span>
                            <span className={themeClasses.text.secondary}>
                              {data.salaryRange}
                            </span>
                          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    {roadmapData.industryInsights.currentTrends && (
                      <div>
                        <h4 className={`font-medium ${themeClasses.text.primary} mb-2`}>Current Trends</h4>
                        <ul className="space-y-1">
                          {roadmapData.industryInsights.currentTrends.map((trend, index) => (
                            <li key={index} className={`text-sm ${themeClasses.text.secondary} flex items-center`}>
                    ...
                    {roadmapData.industryInsights.futureOutlook && (
                      <div>
                        <h4 className={`font-medium ${themeClasses.text.primary} mb-2`}>Future Outlook</h4>
            ...
            {roadmapData?.learningResources && (
              <div className={componentStyles.card}>
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    {Object.entries(roadmapData.learningResources).map(([category, resources]) => (
                      resources && resources.length > 0 && (
                        <div key={category}>
                          <h4 className={`font-medium ${themeClasses.text.primary} mb-2 capitalize`}>
                            {category}
                          </h4>
                          <ul className="space-y-1">
