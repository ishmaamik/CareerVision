...
import { getComponentStyles } from "../../styles/themes";
...
const Roadmap = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        specificArea: (() => {
          ...
          if (!formData.goals.specificArea) {
            ...
            return (
              goalToAreaMap[formData.goals.primaryGoal] ||
      ...
      if (
        !response ||
        !response.roadmap ||
        !response.roadmap.generatedRoadmap
      ) {
  ...
  const handleSkillSelectRoadmap = (skill) => {
    if (!selectedSkills.some((s) => s.id === skill.id)) {
      ...
      setFormData((prev) => ({
        ...prev,
        tools: [...(prev.tools?.split(",") || []), skill.name]
          .filter(Boolean)
          .join(", "),
      }));
    }
  ...
  const removeSkill = (skillToRemove) => {
    ...
    setFormData((prev) => {
      ...
      const updatedSkills = currentSkills.filter(
        (skill) => skill.trim() !== skillToRemove.name
      );
      return {
        ...prev,
    ...
    const simplifyStyles = (el) => {
      ...
      if (el.classList) {
        classesToRemove.forEach((cls) => {
          el.classList.remove(
            ...Array.from(el.classList).filter((c) => c.includes(cls))
          );
        });
      }
      ...
      try {
        ...
        html2pdf()
          ...
          .catch((fallbackErr) => {
            ...
            alert(
              "Failed to generate PDF. Please try manually copying the content."
            );
          });
      } catch (simplificationError) {
        console.error("PDF Simplification Error:", simplificationError);
        alert(
          "Unable to generate PDF. Please try manually copying the content."
        );
      }
    });
  };
  ...
  const findSpecificSkills = (input) => {
    ...
    const matchingSkills = skillsData.filter(
      (skill) =>
                    ...
                    <label className="block">
                      ...
                      >
                        ...
                        <optgroup label="Engineering">
                          ...
                          <option value="aerospace_engineering">
                        ...
                        <optgroup label="Arts & Entertainment">
                          ...
                          <option value="film_media">
                            Film & Media Production
                          </option>
                          <option value="music_production">
                            Music Production
                          </option>
                        ...
                        <optgroup label="Trades & Technical Skills">
                          ...
                          <option value="automotive_technology">
                        ...
                        <optgroup label="Professional Development">
                          <option value="leadership_development">
                            Leadership Development
                          </option>
                          <option value="communication_skills">
                            Communication Skills
                          </option>
                          <option value="personal_branding">
                            Personal Branding
                          </option>
                        </optgroup>
                        ...
                        <option value="career_transition">
                          Career Transition
                        </option>
                  ...
                  <div className="space-y-4">
                    <fieldset className="space-y-2">
                      ...
                      {(() => {
                        ...
                        return careerQuestions.experienceQuestions.map(
                          (question, index) => (
                            <label
                              key={index}
                  ...
                  <div className="space-y-4">
                    <fieldset className="space-y-2">
                      ...
                      {(() => {
                        ...
                        const languageOptions = suggestLanguages(
                          formData.goals.primaryGoal
                        );
                        ...
                        return languageOptions.map((skill) => (
                          ...
                          >
                            <input
                              ...
                              checked={
                                formData.languages &&
                                formData.languages.some((l) => l.name === skill)
                              }
                  ...
                  <div className="space-y-4">
                      ...
                      {showSkillDropdown && (
                        <div className="absolute z-10 mt-1 w-full bg-white border border-amber-200 rounded-lg shadow-lg max-h-60 overflow-auto">
                          {filteredSkills.length > 0 ? (
                            ...
                            <div className="px-4 py-2 text-amber-700">
                    ...
                    {findMatchingSkillCategories(formData.tools).length > 0 && (
                      <div className="mt-2 text-sm text-amber-700">
                        🎯 We've found potential career paths based on your
                        input!
                      </div>
                    )}
                  </div>
