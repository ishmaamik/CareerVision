...
const Signup = () => {
  ...
  return (
    <div
      className={`w-full min-h-screen bg-[var(--bg-primary)] flex items-center justify-center px-4 sm:px-6 lg:px-8 transition-all duration-800 ease-in-out ${
      ...
      <div className="w-full max-w-md sm:max-w-lg lg:max-w-xl themed-card p-6 sm:p-8 lg:p-10">
        ...
        <div className="mt-6 sm:mt-8 text-center">
          <p className="text-sm text-[var(--text-secondary)]">
            ...
            <a
              href="/login"
              className="font-medium text-[var(--accent-primary)] hover:text-blue-500 transition-colors duration-200"
            >
              Sign in here
            </a>
          </p>
