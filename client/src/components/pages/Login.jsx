...
const Login = () => {
  ...
  return (
    <div
      className={`fixed transition-all duration-800 ease-in-out ${
        isMounted ? `opacity-100 translate-y-0` : `opacity-0 translate-y-3`
      } left-1/2 transform -translate-x-1/2  flex items-center justify-center min-h-screen`}
    >
      <div className="w-full max-w-2xl rounded-lg bg-white py-6 px-20 shadow-lg">
        ...
        >
          ...
          <div className=" text-sm justify-center items-center">
            <a
              href=""
              className="font-medium text-indigo-600 justify-center items-center hover:text-indigo-500"
            >
              Forgot password?
            </a>
          </div>
