...
const CompanyProfile = () => {
  ...
  const [companyData, setCompanyData] = useState({
    basicInfo: {
      ...
      description:
        "TechCorp Solutions is a leading technology company specializing in cloud computing, artificial intelligence, and software development. We're committed to creating innovative solutions that transform businesses and improve lives.",
    },
    contactInfo: {
    ...
    benefits: [
      ...
      },
      {
        ...
        category: "Time Off",
        title: "Unlimited PTO",
        description: "Flexible time off policy with minimum 3 weeks",
      },
      {
        id: 3,
        category: "Financial",
        title: "401(k) Matching",
        description: "Up to 6% company matching on retirement contributions",
      },
      {
        id: 4,
        category: "Learning",
      ...
      },
      {
        ...
        description: "Full gym membership or home fitness stipend",
      },
      {
        id: 6,
        category: "Work-Life",
    ...
    hiring: {
      process:
        "4-stage process: Application review, Phone screen, Technical interview, Final interview",
              ...
              <Grid item xs={12} md={6}>
                <FormControl fullWidth sx={componentStyles.textField}>
                  ...
                  >
                    ...
                    <MenuItem value="501-1000 employees">
                      501-1000 employees
                    </MenuItem>
  ...
  const BenefitsCultureTab = () => (
    <Grid container spacing={3}>
      <Grid item xs={12} lg={8}>
        ...
        {/* Add Benefit Dialog */}
        <Dialog
          open={addBenefitDialog}
          onClose={() => setAddBenefitDialog(false)}
          maxWidth="sm"
          fullWidth
        >
                  ...
                  <Switch
                    ...
                    onChange={(e) =>
                      setCompanyData({
                        ...
                        culture: {
                          ...companyData.culture,
                          diversityCommitment: e.target.checked,
                        },
                      })
                    }
                  />
