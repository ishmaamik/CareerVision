...
// Category mapping for article search
const CATEGORY_KEYWORDS = {
  All: "career development technology",
  "Job Related": "job search career advice",
  "Tech & Programming": "programming technology software",
  "Business & Finance": "business finance startup",
  "Education & Learning": "education learning skills",
  "Career Growth": "career growth professional development",
  "Psychology & Wellness": "workplace wellness mental health",
};

const Articles = ({ searchTerm = "", category = "All" }) => {
  ...
  const fetchArticles = async (query) => {
    ...
    try {
      const response = await axios.get(
        `https://newsapi.org/v2/everything?q=${query}&apiKey=${apiKey}&sortBy=popularity&pageSize=20`
      );
  ...
  useEffect(() => {
    let query = CATEGORY_KEYWORDS[category] || "career development technology";

    // If searchTerm is provided, combine it with category keywords
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Stay updated with the latest trends, insights, and knowledge to
              advance your career
            </p>
            ...
            {articles.length > 0 ? (
              <>
                    ...
                    <Card className="shadow-xl rounded-3xl overflow-hidden border-0 group hover:shadow-2xl transition-all duration-300">
                      <div className="md:flex">
                        <div className="md:w-1/2">
                          <img
                            src={
                              articles[0].urlToImage || "/default-article.jpg"
                            }
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2 text-slate-500">
                              ...
                              <span className="text-sm">
                                {articles[0].author || "Unknown Author"}
                              </span>
                            </div>
                ...
                <div className="mb-8">
                  <Typography
                    variant="h4"
                    className="font-bold text-slate-800 mb-8"
                  >
                    Latest Articles
                  </Typography>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {articles.slice(1).map((article, index) => (
                      ...
                      >
                        <div className="relative">
                          ...
                          <div className="absolute top-4 right-4">
                            <IconButton
                              ...
                              size="small"
                            >
                              {bookmarkedArticles.has(index + 1) ? (
                                <Bookmark />
                              ) : (
                                <BookmarkBorder />
                              )}
                        ...
                        <CardContent className="p-6">
                          ...
                          <Typography
                            variant="h6"
                            className="font-bold text-slate-800 mb-3 leading-tight group-hover:text-blue-600 transition-colors"
                          >
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                            <div className="flex items-center space-x-2 text-slate-500 text-sm">
                              <Person className="w-4 h-4" />
                              <span>
                                {truncateText(article.author || "Unknown", 2)}
                              </span>
                            </div>
