...
export const careerMatches = {
  "high-tech-analytical": {
    careers: ["Software Engineer", "Data Scientist", "Cybersecurity Analyst", "AI Researcher"],
    description: "You excel in technology and analytical thinking",
    color: "#3B82F6"
  },
  "creative-communication": {
    careers: ["UX Designer", "Marketing Manager", "Content Creator", "Art Director"],
    description: "You have strong creative and communication skills",
    color: "#8B5CF6"
  },
  "leadership-business": {
    careers: ["Product Manager", "Business Analyst", "Management Consultant", "Entrepreneur"],
  ...
  "analytical-finance": {
    careers: ["Financial Analyst", "Investment Banker", "Accountant", "Risk Manager"],
  ...
  "creative-media": {
    careers: ["Journalist", "Photographer", "Video Producer", "Graphic Designer"],
    description: "You excel in creative media and storytelling",
    color: "#EC4899"
  },
  "research-science": {
    careers: ["Research Scientist", "Lab Technician", "Environmental Scientist", "Biologist"],
...
export const personalityTypes = [
  {
    ...
    traits: ["Problem Solving", "Critical Thinking", "Data-Driven", "Systematic"],
    careers: ["Data Scientist", "Research Analyst", "Financial Analyst", "Software Engineer"],
    color: "#3B82F6"
  },
  {
    id: "creator",
    ...
    traits: ["Creativity", "Innovation", "Artistic Vision", "Original Thinking"],
  ...
  },
  {
    ...
    traits: ["Leadership", "Decision Making", "Strategic Thinking", "Motivation"],
  ...
  },
  {
    ...
    careers: ["Project Manager", "Accountant", "Operations Manager", "Administrator"],
    color: "#6366F1"
  }
];

export const industryPreferences = [
  { id: "technology", name: "Technology", icon: "💻", description: "Software, AI, and digital innovation" },
  { id: "healthcare", name: "Healthcare", icon: "🏥", description: "Medical care and life sciences" },
  { id: "finance", name: "Finance", icon: "💰", description: "Banking, investments, and financial services" },
  { id: "education", name: "Education", icon: "📚", description: "Teaching and educational technology" },
  { id: "creative", name: "Creative Arts", icon: "🎨", description: "Design, media, and entertainment" },
  { id: "business", name: "Business", icon: "💼", description: "Consulting, management, and strategy" },
  { id: "engineering", name: "Engineering", icon: "⚙️", description: "Manufacturing and technical solutions" },
  { id: "science", name: "Science & Research", icon: "🔬", description: "Research and scientific discovery" },
  { id: "social", name: "Social Impact", icon: "🤝", description: "Non-profit and social causes" },
  { id: "environment", name: "Environment", icon: "🌱", description: "Sustainability and green technology" }
];

export const workEnvironmentPreferences = [
  { id: "office", name: "Traditional Office", icon: "🏢", description: "Structured office environment" },
  { id: "remote", name: "Remote Work", icon: "🏠", description: "Work from anywhere flexibility" },
  { id: "hybrid", name: "Hybrid", icon: "⚡", description: "Mix of office and remote work" },
  { id: "startup", name: "Startup", icon: "🚀", description: "Fast-paced, innovative environment" },
  { id: "corporate", name: "Large Corporation", icon: "🏛️", description: "Established, structured company" },
  { id: "outdoors", name: "Outdoor Work", icon: "🌲", description: "Field work and outdoor activities" }
];