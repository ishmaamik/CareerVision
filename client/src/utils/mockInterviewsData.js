...
export const mockInterviewSessions = [
  {
    ...
    feedback: {
      ...
      detailedFeedback:
        "You demonstrated excellent problem-solving skills and wrote clean, well-structured code. Your communication was clear throughout the interview. However, consider studying more system design patterns and scalability concepts for senior-level positions.",
    },
    questions: [
      {
        id: "q1",
  ...
  },
  {
    ...
    feedback: {
      ...
      detailedFeedback:
        "You showed strong user empathy and strategic thinking. Your market analysis was thorough. To improve, focus more on data-driven decision making and consider technical constraints when proposing solutions.",
    },
    questions: [
      {
        id: "q1",
        ...
        answer:
          "Focused on productivity features, virtual presence, and integration improvements",
        timeSpent: 35,
        score: 80,
      },
      {
        ...
        answer:
          "Used bottom-up approach considering enterprise and consumer segments",
        timeSpent: 25,
        score: 75,
      },
      {
  ...
  },
  {
    ...
    feedback: {
      ...
      detailedFeedback:
        "Outstanding use of the STAR method with compelling examples. You showed strong self-awareness and learning from experiences. Consider including more quantified impacts and discussing how you handle failures and setbacks.",
    },
    questions: [
      {
        id: "q1",
        ...
        answer:
          "Shared example about rebuilding team trust after project failure",
        timeSpent: 8,
        score: 95,
      },
      {
      ...
      },
      {
        ...
        answer:
          "Explained respectful disagreement and collaborative solution finding",
        timeSpent: 12,
        score: 88,
      },
      {
        ...
        answer:
          "Shared project failure, lessons learned, and subsequent improvements",
        timeSpent: 15,
        score: 95,
      },
    ],
  ...
  },
  {
    ...
    feedback: {
      ...
      detailedFeedback:
        "You demonstrated excellent enthusiasm and cultural fit. Your growth mindset is impressive. To strengthen your profile, focus on developing deeper industry knowledge and technical skills relevant to the finance sector.",
    },
    questions: [
      {
        id: "q1",
        ...
        answer:
          "Emphasized learning opportunities, impact, and growth potential",
        timeSpent: 5,
        score: 90,
      },
      {
        ...
        answer:
          "Researched company mission, recent funding, and market position",
        timeSpent: 8,
        score: 85,
      },
      {
        ...
        answer:
          "Discussed career progression and contribution to company growth",
        timeSpent: 7,
        score: 88,
      },
      {
...
export const upcomingInterviewSchedule = [
  ...
  },
  {
    ...
    duration: 60,
    description:
      "System design interview for senior software engineer position",
    interviewer: {
...
export const companies = [
  {
    ...
    interviewStyles: ["technical", "behavioral"],
  },
  {
    id: "microsoft",
    name: "Microsoft",
    logo: "/logos/microsoft.png",
    interviewStyles: ["technical", "behavioral", "case_study"],
  },
  {
    id: "amazon",
    name: "Amazon",
    logo: "/logos/amazon.png",
    interviewStyles: ["behavioral", "technical"],
  },
  {
    id: "meta",
    name: "Meta",
  ...
  },
  {
    ...
    interviewStyles: ["case_study", "behavioral"],
  },
  {
    id: "goldman_sachs",
    name: "Goldman Sachs",
    logo: "/logos/goldman.png",
    interviewStyles: ["behavioral", "case_study"],
  },
  {
    id: "jpmorgan",
    name: "JPMorgan Chase",
