...
export const interviewGuideCategories = [
  {
    ...
    description:
      "Master the art of storytelling and demonstrate your soft skills",
    icon: "psychology",
    color: "#3B82F6",
    guideCount: 15,
    questionCount: 120,
...
export const featuredGuides = [
  {
    ...
    description:
      "Learn the proven STAR (Situation, Task, Action, Result) framework to structure compelling interview responses",
    topics: [
      "STAR Framework",
      "Story Structure",
      "Impact Measurement",
  ...
  },
  {
    ...
    description:
      "Comprehensive guide to approaching system design questions for senior engineering roles",
    topics: [
  ...
  },
  {
    ...
    description:
      "Master the structured thinking approach used by top consulting firms",
    topics: [
      "MECE Principle",
      "Issue Trees",
      "Hypothesis Testing",
  ...
  },
  {
    ...
    description:
      "Understand and demonstrate Amazon's 16 leadership principles with real examples",
    topics: [
      "Customer Obsession",
      "Ownership",
      "Invent and Simplify",
  ...
  caseStudy: [
    {
      id: "c001",
      question:
        "How would you increase profitability for a declining coffee shop chain?",
...
export const companySpecificGuides = [
  ...
  },
  {
    ...
    culture:
      "Client-focused, analytical excellence, collaborative problem-solving",
    values: [
      "Client impact",
    ...
    tips: [
      {
        ...
        description:
          "Understand their mission, values, recent news, and competitors. Show genuine interest and cultural fit.",
      },
      {
        tip: "Practice your stories using the STAR method",
        description:
          "Prepare 7-10 compelling examples that demonstrate different skills and competencies.",
      },
      {
        tip: "Prepare thoughtful questions to ask",
        description:
          "Show engagement and interest by asking about company culture, growth opportunities, and challenges.",
      },
      {
        tip: "Do mock interviews",
        description:
          "Practice with friends, mentors, or professional services to get comfortable with the format.",
      },
    ],
  },
  {
    ...
    tips: [
      {
        ...
        description:
          "Show engagement by taking notes and asking clarifying questions when needed.",
      },
      {
        tip: "Think out loud for technical problems",
        description:
          "Walk through your thought process so interviewers can follow your reasoning.",
      },
      {
        tip: "Be specific with examples",
        description:
          "Use concrete details, metrics, and outcomes to make your stories memorable and credible.",
      },
      {
        tip: "Show enthusiasm and energy",
        description:
          "Demonstrate genuine interest in the role and company through your body language and responses.",
      },
    ],
  },
  {
    ...
    tips: [
      {
        ...
        description:
          "Personalize your message by referencing specific conversation points from the interview.",
      },
      {
        tip: "Reflect on your performance",
        description:
          "Note what went well and areas for improvement for future interviews.",
      },
      {
        tip: "Follow up appropriately",
        description:
          "If you don't hear back within the stated timeframe, send a polite follow-up email.",
      },
      {
        tip: "Continue interviewing elsewhere",
        description:
          "Don't put all your eggs in one basket - keep other opportunities active.",
      },
    ],
  },
];
...
export const industryGuides = [
  ...
  },
  {
    ...
    description:
      "Succeed in investment banking, private equity, and financial services",
    keySkills: [
      "Financial modeling",
      "Analytical skills",
      "Attention to detail",
...
export const popularResources = [
  {
    ...
    rating: 4.8,
    description:
      "Essential guide for technical interview preparation with 189 programming questions",
  ...
  },
  {
    ...
    rating: 4.9,
    description:
      "Comprehensive course on behavioral interview techniques and storytelling",
    topics: [
      "STAR Method",
      "Leadership Stories",
      "Conflict Resolution",
